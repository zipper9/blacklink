...
GENERATED=crypto\aes\aesni-mb-x86_64.asm crypto\aes\aesni-sha1-x86_64.asm crypto\aes\aesni-sha256-x86_64.asm crypto\aes\aesni-x86_64.asm crypto\aes\vpaes-x86_64.asm crypto\bn\rsaz-avx2.asm crypto\bn\rsaz-x86_64.asm crypto\bn\x86_64-gf2m.asm crypto\bn\x86_64-mont.asm crypto\bn\x86_64-mont5.asm crypto\buildinf.h crypto\chacha\chacha-x86_64.asm crypto\ec\ecp_nistz256-x86_64.asm crypto\ec\x25519-x86_64.asm crypto\md5\md5-x86_64.asm crypto\modes\aesni-gcm-x86_64.asm crypto\modes\ghash-x86_64.asm crypto\poly1305\poly1305-x86_64.asm crypto\rc4\rc4-md5-x86_64.asm crypto\rc4\rc4-x86_64.asm crypto\sha\keccak1600-x86_64.asm crypto\sha\sha1-mb-x86_64.asm crypto\sha\sha1-x86_64.asm crypto\sha\sha256-mb-x86_64.asm crypto\sha\sha256-x86_64.asm crypto\sha\sha512-x86_64.asm crypto\whrlpool\wp-x86_64.asm crypto\x86_64cpuid.asm
...
CPPFLAGS_Q=-D"L_ENDIAN" -D"OPENSSL_PIC" -D"OPENSSL_CPUID_OBJ" -D"OPENSSL_IA32_SSE2" -D"OPENSSL_BN_ASM_MONT" -D"OPENSSL_BN_ASM_MONT5" -D"OPENSSL_BN_ASM_GF2m" -D"SHA1_ASM" -D"SHA256_ASM" -D"SHA512_ASM" -D"KECCAK1600_ASM" -D"RC4_ASM" -D"MD5_ASM" -D"AESNI_ASM" -D"VPAES_ASM" -D"GHASH_ASM" -D"ECP_NISTZ256_ASM" -D"X25519_ASM" -D"POLY1305_ASM"
...
$(OUTDIR)\bf_enc.obj: "crypto\bf\bf_enc.c"
	$(CC)  $(LIB_CFLAGS) /I "." /I "include" $(LIB_CPPFLAGS) -c $(COUTFLAG)$@ "crypto\bf\bf_enc.c"
...
$(OUTDIR)\bn_asm.obj: "crypto\bn\bn_asm.c"
	$(CC)  $(LIB_CFLAGS) /I "." /I "include" $(LIB_CPPFLAGS) -c $(COUTFLAG)$@ "crypto\bn\bn_asm.c"
...
$(OUTDIR)\rsaz_exp.obj: "crypto\bn\rsaz_exp.c"
	$(CC)  $(LIB_CFLAGS) /I "." /I "include" $(LIB_CPPFLAGS) -c $(COUTFLAG)$@ "crypto\bn\rsaz_exp.c"
...
$(OUTDIR)\des_enc.obj: "crypto\des\des_enc.c"
	$(CC)  $(LIB_CFLAGS) /I "." /I "include" $(LIB_CPPFLAGS) -c $(COUTFLAG)$@ "crypto\des\des_enc.c"
...
$(OUTDIR)\fcrypt_b.obj: "crypto\des\fcrypt_b.c"
	$(CC)  $(LIB_CFLAGS) /I "." /I "include" $(LIB_CPPFLAGS) -c $(COUTFLAG)$@ "crypto\des\fcrypt_b.c"
...
crypto\ec\x25519-x86_64.asm: "crypto\ec\asm\x25519-x86_64.pl" 
	set ASM=$(AS)
	"$(PERL)" "crypto\ec\asm\x25519-x86_64.pl" $(PERLASM_SCHEME) $@
...
crypto\sha\keccak1600-x86_64.asm: "crypto\sha\asm\keccak1600-x86_64.pl" 
	set ASM=$(AS)
	"$(PERL)" "crypto\sha\asm\keccak1600-x86_64.pl" $(PERLASM_SCHEME) $@
...
crypto crypto\ : $(OUTDIR)\cpt_err.obj $(OUTDIR)\cryptlib.obj $(OUTDIR)\ctype.obj $(OUTDIR)\cversion.obj $(OUTDIR)\ebcdic.obj $(OUTDIR)\ex_data.obj $(OUTDIR)\getenv.obj $(OUTDIR)\init.obj $(OUTDIR)\mem.obj $(OUTDIR)\mem_dbg.obj $(OUTDIR)\mem_sec.obj $(OUTDIR)\o_dir.obj $(OUTDIR)\o_fips.obj $(OUTDIR)\o_fopen.obj $(OUTDIR)\o_init.obj $(OUTDIR)\o_str.obj $(OUTDIR)\o_time.obj $(OUTDIR)\threads_none.obj $(OUTDIR)\threads_pthread.obj $(OUTDIR)\threads_win.obj $(OUTDIR)\uid.obj $(OUTDIR)\x86_64cpuid.obj
crypto\aes crypto\aes\ : $(OUTDIR)\aes_cbc.obj $(OUTDIR)\aes_cfb.obj $(OUTDIR)\aes_core.obj $(OUTDIR)\aes_ecb.obj $(OUTDIR)\aes_ige.obj $(OUTDIR)\aes_misc.obj $(OUTDIR)\aes_ofb.obj $(OUTDIR)\aes_wrap.obj $(OUTDIR)\aesni-mb-x86_64.obj $(OUTDIR)\aesni-sha1-x86_64.obj $(OUTDIR)\aesni-sha256-x86_64.obj $(OUTDIR)\aesni-x86_64.obj $(OUTDIR)\vpaes-x86_64.obj
...
crypto\bf crypto\bf\ : $(OUTDIR)\bf_cfb64.obj $(OUTDIR)\bf_ecb.obj $(OUTDIR)\bf_enc.obj $(OUTDIR)\bf_ofb64.obj $(OUTDIR)\bf_skey.obj
...
crypto\bn crypto\bn\ : $(OUTDIR)\bn_add.obj $(OUTDIR)\bn_asm.obj $(OUTDIR)\bn_blind.obj $(OUTDIR)\bn_const.obj $(OUTDIR)\bn_ctx.obj $(OUTDIR)\bn_depr.obj $(OUTDIR)\bn_dh.obj $(OUTDIR)\bn_div.obj $(OUTDIR)\bn_err.obj $(OUTDIR)\bn_exp.obj $(OUTDIR)\bn_exp2.obj $(OUTDIR)\bn_gcd.obj $(OUTDIR)\bn_gf2m.obj $(OUTDIR)\bn_intern.obj $(OUTDIR)\bn_kron.obj $(OUTDIR)\bn_lib.obj $(OUTDIR)\bn_mod.obj $(OUTDIR)\bn_mont.obj $(OUTDIR)\bn_mpi.obj $(OUTDIR)\bn_mul.obj $(OUTDIR)\bn_nist.obj $(OUTDIR)\bn_prime.obj $(OUTDIR)\bn_print.obj $(OUTDIR)\bn_rand.obj $(OUTDIR)\bn_recp.obj $(OUTDIR)\bn_shift.obj $(OUTDIR)\bn_sqr.obj $(OUTDIR)\bn_sqrt.obj $(OUTDIR)\bn_srp.obj $(OUTDIR)\bn_word.obj $(OUTDIR)\bn_x931p.obj $(OUTDIR)\rsaz-avx2.obj $(OUTDIR)\rsaz-x86_64.obj $(OUTDIR)\rsaz_exp.obj $(OUTDIR)\x86_64-gf2m.obj $(OUTDIR)\x86_64-mont.obj $(OUTDIR)\x86_64-mont5.obj
crypto\buffer crypto\buffer\ : $(OUTDIR)\buf_err.obj $(OUTDIR)\buffer.obj
crypto\chacha crypto\chacha\ : $(OUTDIR)\chacha-x86_64.obj
...
crypto\des crypto\des\ : $(OUTDIR)\cbc_cksm.obj $(OUTDIR)\cbc_enc.obj $(OUTDIR)\cfb64ede.obj $(OUTDIR)\cfb64enc.obj $(OUTDIR)\cfb_enc.obj $(OUTDIR)\des_enc.obj $(OUTDIR)\ecb3_enc.obj $(OUTDIR)\ecb_enc.obj $(OUTDIR)\fcrypt.obj $(OUTDIR)\fcrypt_b.obj $(OUTDIR)\ofb64ede.obj $(OUTDIR)\ofb64enc.obj $(OUTDIR)\ofb_enc.obj $(OUTDIR)\pcbc_enc.obj $(OUTDIR)\qud_cksm.obj $(OUTDIR)\rand_key.obj $(OUTDIR)\set_key.obj $(OUTDIR)\str2key.obj $(OUTDIR)\xcbc_enc.obj
...
crypto\ec crypto\ec\ : $(OUTDIR)\curve25519.obj $(OUTDIR)\ec2_oct.obj $(OUTDIR)\ec2_smpl.obj $(OUTDIR)\ec_ameth.obj $(OUTDIR)\ec_asn1.obj $(OUTDIR)\ec_check.obj $(OUTDIR)\ec_curve.obj $(OUTDIR)\ec_cvt.obj $(OUTDIR)\ec_err.obj $(OUTDIR)\ec_key.obj $(OUTDIR)\ec_kmeth.obj $(OUTDIR)\ec_lib.obj $(OUTDIR)\ec_mult.obj $(OUTDIR)\ec_oct.obj $(OUTDIR)\ec_pmeth.obj $(OUTDIR)\ec_print.obj $(OUTDIR)\ecdh_kdf.obj $(OUTDIR)\ecdh_ossl.obj $(OUTDIR)\ecdsa_ossl.obj $(OUTDIR)\ecdsa_sign.obj $(OUTDIR)\ecdsa_vrf.obj $(OUTDIR)\eck_prn.obj $(OUTDIR)\ecp_mont.obj $(OUTDIR)\ecp_nist.obj $(OUTDIR)\ecp_nistp224.obj $(OUTDIR)\ecp_nistp256.obj $(OUTDIR)\ecp_nistp521.obj $(OUTDIR)\ecp_nistputil.obj $(OUTDIR)\ecp_nistz256-x86_64.obj $(OUTDIR)\ecp_nistz256.obj $(OUTDIR)\ecp_oct.obj $(OUTDIR)\ecp_smpl.obj $(OUTDIR)\ecx_meth.obj $(OUTDIR)\x25519-x86_64.obj
...
crypto\md5 crypto\md5\ : $(OUTDIR)\md5-x86_64.obj $(OUTDIR)\md5_dgst.obj $(OUTDIR)\md5_one.obj
crypto\modes crypto\modes\ : $(OUTDIR)\aesni-gcm-x86_64.obj $(OUTDIR)\cbc128.obj $(OUTDIR)\ccm128.obj $(OUTDIR)\cfb128.obj $(OUTDIR)\ctr128.obj $(OUTDIR)\cts128.obj $(OUTDIR)\gcm128.obj $(OUTDIR)\ghash-x86_64.obj $(OUTDIR)\ocb128.obj $(OUTDIR)\ofb128.obj $(OUTDIR)\wrap128.obj $(OUTDIR)\xts128.obj
...
crypto\poly1305 crypto\poly1305\ : $(OUTDIR)\poly1305-x86_64.obj $(OUTDIR)\poly1305.obj $(OUTDIR)\poly1305_ameth.obj $(OUTDIR)\poly1305_pmeth.obj
...
crypto\rc4 crypto\rc4\ : $(OUTDIR)\rc4-md5-x86_64.obj $(OUTDIR)\rc4-x86_64.obj
crypto\ripemd crypto\ripemd\ : $(OUTDIR)\rmd_dgst.obj $(OUTDIR)\rmd_one.obj
...
crypto\sha crypto\sha\ : $(OUTDIR)\keccak1600-x86_64.obj $(OUTDIR)\sha1-mb-x86_64.obj $(OUTDIR)\sha1-x86_64.obj $(OUTDIR)\sha1_one.obj $(OUTDIR)\sha1dgst.obj $(OUTDIR)\sha256-mb-x86_64.obj $(OUTDIR)\sha256-x86_64.obj $(OUTDIR)\sha256.obj $(OUTDIR)\sha512-x86_64.obj $(OUTDIR)\sha512.obj
...
crypto\whrlpool crypto\whrlpool\ : $(OUTDIR)\wp-x86_64.obj $(OUTDIR)\wp_dgst.obj
