...
CNF_ASFLAGS=
CNF_CPPFLAGS=-D"OPENSSL_SYS_WIN32" -D"WIN32_LEAN_AND_MEAN" -D"UNICODE" -D"_UNICODE" -D"_CRT_SECURE_NO_DEPRECATE" -D"_WINSOCK_DEPRECATED_NO_WARNINGS" -D"_ARM_WINAPI_PARTITION_DESKTOP_SDK_AVAILABLE" -D"OPENSSL_SYS_WIN_CORE"  $(DBG_DEFINES)
...
LIB_CPPFLAGS=-D"L_ENDIAN" -D"OPENSSL_PIC" -D"OPENSSLDIR=\".\""  $(CNF_CPPFLAGS) $(CPPFLAGS)
...
$(OUTDIR)\chacha_enc.obj: "crypto\chacha\chacha_enc.c"
	$(CC)  $(LIB_CFLAGS) /I "." /I "include" $(LIB_CPPFLAGS) -c $(COUTFLAG)$@ "crypto\chacha\chacha_enc.c"
...
$(OUTDIR)\mem_clr.obj: "crypto\mem_clr.c"
	$(CC)  $(LIB_CFLAGS) /I "." /I "include" $(LIB_CPPFLAGS) -c $(COUTFLAG)$@ "crypto\mem_clr.c"
...
$(OUTDIR)\rc4_enc.obj: "crypto\rc4\rc4_enc.c"
	$(CC)  $(LIB_CFLAGS) /I "." /I "include" $(LIB_CPPFLAGS) -c $(COUTFLAG)$@ "crypto\rc4\rc4_enc.c"
$(OUTDIR)\rc4_skey.obj: "crypto\rc4\rc4_skey.c"
	$(CC)  $(LIB_CFLAGS) /I "." /I "include" $(LIB_CPPFLAGS) -c $(COUTFLAG)$@ "crypto\rc4\rc4_skey.c"
...
crypto crypto\ : $(OUTDIR)\cpt_err.obj $(OUTDIR)\cryptlib.obj $(OUTDIR)\ctype.obj $(OUTDIR)\cversion.obj $(OUTDIR)\ebcdic.obj $(OUTDIR)\ex_data.obj $(OUTDIR)\getenv.obj $(OUTDIR)\init.obj $(OUTDIR)\mem.obj $(OUTDIR)\mem_clr.obj $(OUTDIR)\mem_dbg.obj $(OUTDIR)\mem_sec.obj $(OUTDIR)\o_dir.obj $(OUTDIR)\o_fips.obj $(OUTDIR)\o_fopen.obj $(OUTDIR)\o_init.obj $(OUTDIR)\o_str.obj $(OUTDIR)\o_time.obj $(OUTDIR)\threads_none.obj $(OUTDIR)\threads_pthread.obj $(OUTDIR)\threads_win.obj $(OUTDIR)\uid.obj
crypto\aes crypto\aes\ : $(OUTDIR)\aes_cbc.obj $(OUTDIR)\aes_cfb.obj $(OUTDIR)\aes_core.obj $(OUTDIR)\aes_ecb.obj $(OUTDIR)\aes_ige.obj $(OUTDIR)\aes_misc.obj $(OUTDIR)\aes_ofb.obj $(OUTDIR)\aes_wrap.obj
...
crypto\bn crypto\bn\ : $(OUTDIR)\bn_add.obj $(OUTDIR)\bn_asm.obj $(OUTDIR)\bn_blind.obj $(OUTDIR)\bn_const.obj $(OUTDIR)\bn_ctx.obj $(OUTDIR)\bn_depr.obj $(OUTDIR)\bn_dh.obj $(OUTDIR)\bn_div.obj $(OUTDIR)\bn_err.obj $(OUTDIR)\bn_exp.obj $(OUTDIR)\bn_exp2.obj $(OUTDIR)\bn_gcd.obj $(OUTDIR)\bn_gf2m.obj $(OUTDIR)\bn_intern.obj $(OUTDIR)\bn_kron.obj $(OUTDIR)\bn_lib.obj $(OUTDIR)\bn_mod.obj $(OUTDIR)\bn_mont.obj $(OUTDIR)\bn_mpi.obj $(OUTDIR)\bn_mul.obj $(OUTDIR)\bn_nist.obj $(OUTDIR)\bn_prime.obj $(OUTDIR)\bn_print.obj $(OUTDIR)\bn_rand.obj $(OUTDIR)\bn_recp.obj $(OUTDIR)\bn_shift.obj $(OUTDIR)\bn_sqr.obj $(OUTDIR)\bn_sqrt.obj $(OUTDIR)\bn_srp.obj $(OUTDIR)\bn_word.obj $(OUTDIR)\bn_x931p.obj
crypto\buffer crypto\buffer\ : $(OUTDIR)\buf_err.obj $(OUTDIR)\buffer.obj
crypto\chacha crypto\chacha\ : $(OUTDIR)\chacha_enc.obj
...
crypto\ec crypto\ec\ : $(OUTDIR)\curve25519.obj $(OUTDIR)\ec2_oct.obj $(OUTDIR)\ec2_smpl.obj $(OUTDIR)\ec_ameth.obj $(OUTDIR)\ec_asn1.obj $(OUTDIR)\ec_check.obj $(OUTDIR)\ec_curve.obj $(OUTDIR)\ec_cvt.obj $(OUTDIR)\ec_err.obj $(OUTDIR)\ec_key.obj $(OUTDIR)\ec_kmeth.obj $(OUTDIR)\ec_lib.obj $(OUTDIR)\ec_mult.obj $(OUTDIR)\ec_oct.obj $(OUTDIR)\ec_pmeth.obj $(OUTDIR)\ec_print.obj $(OUTDIR)\ecdh_kdf.obj $(OUTDIR)\ecdh_ossl.obj $(OUTDIR)\ecdsa_ossl.obj $(OUTDIR)\ecdsa_sign.obj $(OUTDIR)\ecdsa_vrf.obj $(OUTDIR)\eck_prn.obj $(OUTDIR)\ecp_mont.obj $(OUTDIR)\ecp_nist.obj $(OUTDIR)\ecp_nistp224.obj $(OUTDIR)\ecp_nistp256.obj $(OUTDIR)\ecp_nistp521.obj $(OUTDIR)\ecp_nistputil.obj $(OUTDIR)\ecp_oct.obj $(OUTDIR)\ecp_smpl.obj $(OUTDIR)\ecx_meth.obj
...
crypto\md5 crypto\md5\ : $(OUTDIR)\md5_dgst.obj $(OUTDIR)\md5_one.obj
crypto\modes crypto\modes\ : $(OUTDIR)\cbc128.obj $(OUTDIR)\ccm128.obj $(OUTDIR)\cfb128.obj $(OUTDIR)\ctr128.obj $(OUTDIR)\cts128.obj $(OUTDIR)\gcm128.obj $(OUTDIR)\ocb128.obj $(OUTDIR)\ofb128.obj $(OUTDIR)\wrap128.obj $(OUTDIR)\xts128.obj
...
crypto\poly1305 crypto\poly1305\ : $(OUTDIR)\poly1305.obj $(OUTDIR)\poly1305_ameth.obj $(OUTDIR)\poly1305_pmeth.obj
...
crypto\rc4 crypto\rc4\ : $(OUTDIR)\rc4_enc.obj $(OUTDIR)\rc4_skey.obj
...
crypto\sha crypto\sha\ : $(OUTDIR)\keccak1600.obj $(OUTDIR)\sha1_one.obj $(OUTDIR)\sha1dgst.obj $(OUTDIR)\sha256.obj $(OUTDIR)\sha512.obj
...
crypto\whrlpool crypto\whrlpool\ : $(OUTDIR)\wp_block.obj $(OUTDIR)\wp_dgst.obj
