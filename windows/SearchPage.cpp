...
{
	{ IDC_SAVE_SEARCH, Conf::FORGET_SEARCH_REQUEST, PropPage::T_BOOL, PropPage::FLAG_INVERT },
	{ IDC_SEARCH_HISTORY, Conf::SEARCH_HISTORY, PropPage::T_INT, PropPage::FLAG_CREATE_SPIN },
