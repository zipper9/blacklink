...
static BaseSettingsImpl::MinMaxValidator<int> validatePopupWidth(200, 600);
static BaseSettingsImpl::MinMaxValidator<int> validatePopupHeight(100, 360);
...
void Conf::initUiSettings()
{
	...
	s->addInt(POPUP_WIDTH, "PopupWidth", 320, 0, &validatePopupWidth);
	s->addInt(POPUP_HEIGHT, "PopupHeight", 120, 0, &validatePopupHeight);
	s->addInt(POPUP_MAX_LENGTH, "PopupMaxLength", 120, 0, &validatePopupMaxLength);
	s->addInt(POPUP_BACKGROUND_COLOR, "PopupBackColor", RGB(217, 234, 247));
	s->addInt(POPUP_TEXT_COLOR, "PopupTextColor", RGB(0, 0, 0));
	s->addInt(POPUP_TITLE_TEXT_COLOR, "PopupTitleTextColor", RGB(21, 67, 101));
	s->addInt(POPUP_BORDER_COLOR, "PopupBorderColor", RGB(21, 67, 101));
