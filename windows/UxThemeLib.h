#ifndef UX_THEME_LIB_H_
#define UX_THEME_LIB_H_
...
class UxThemeLib
{
	public:
		...
		UxThemeLib() : hModule(nullptr), initialized(false) { clearPointers(); }
		~UxThemeLib() { uninit(); }

		UxThemeLib(const UxThemeLib&) = delete;
		UxThemeLib& operator= (const UxThemeLib&) = delete;

		void init();
		void uninit();

		static UxThemeLib instance;
