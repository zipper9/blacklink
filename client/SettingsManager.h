...
class SettingsManager : public Singleton<SettingsManager>, public Speaker<SettingsManagerListener>
{
	public:
		...
		enum IntSetting { INT_FIRST = STR_LAST + 1,
		                  INCOMING_CONNECTIONS = INT_FIRST, AVDB_BLOCK_CONNECTIONS, AUTO_PASSIVE_INCOMING_CONNECTIONS, FORCE_PASSIVE_INCOMING_CONNECTIONS,
						  OVERRIDE_CLIENT_ID,
						  TCP_PORT, UDP_PORT, SLOTS, AUTO_FOLLOW, CLEAR_SEARCH,
