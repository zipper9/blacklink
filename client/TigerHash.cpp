...
{
	unsigned tmppos = (unsigned) (pos & (BLOCK_SIZE - 1));
	...
	if (tmppos)
	{
		const size_t n = std::min<size_t>(length, BLOCK_SIZE - tmppos);
...
const uint64_t TigerHash::table[4 * 256] =
{
