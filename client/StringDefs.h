...
enum Strings   // @DontAdd
{
	...
	PROGRESS_BACK, // "Transfers progress bar - background"
	PROGRESS_SEGMENT, // "Transfers progress bar - actual segment"
	PROGRESS_DOWNLOADED, // "Queue progress bar - downloaded chunks"
	PROGRESS_RUNNING, // "Queue progress bar - running chunks"
	PROGRESS_RUNNING_COMPLETED, // "Queue progress bar - running chunks, second color"
